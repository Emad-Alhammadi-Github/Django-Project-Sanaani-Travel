...
#     # تغيير حالة الحجز إلى 'approved'
#     reservation.status = 'approved'
#     reservation.save()

#     # إضافة المسافر إلى جدول Passenger
#     passenger = Passenger(
#         name=reservation.passenger.name,
#         id_number=reservation.passenger.id_number,
#         passport_number=reservation.passenger.passport_number,
#         phone=reservation.passenger.phone,
#         trip_location=reservation.passenger.trip_location,
#         paid_amount=reservation.passenger.paid_amount,
#         remaining_amount=reservation.passenger.remaining_amount,
#         seat_number=reservation.passenger.seat_number,
#         gender=reservation.passenger.gender,
#         nationality=reservation.passenger.nationality,
#         image=reservation.passenger.image
#     )
#     passenger.save()

#     # إنشاء الفاتورة للمسافر
...
#         trip_date=passenger.trip_location.date,
#         time=passenger.trip_location.time,
#         total_amount=passenger.paid_amount + passenger.remaining_amount,
#     )
#     invoice.save()

#     return HttpResponseRedirect(request.META.get('HTTP_REFERER'))  # العودة إلى الصفحة السابقة
